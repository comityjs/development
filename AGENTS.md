# AGENTS.md — Comity Development Repository

## Purpose

This repository owns Comity-wide governance: standards, architectural decisions, contributor conventions, and shared development infrastructure.

It is the canonical source for cross-repository contracts. Community and Enterprise consume from here.
